...
#ifndef MULTI_DHCP_CONSTANTS_H
#define MULTI_DHCP_CONSTANTS_H

#define MAX_OPT_LEN 512 // RFC 2131
...
#define BOOTP_PORT_PAIR ((BOOTP_SERVER_PORT << 16) + BOOTP_CLIENT_PORT) //THIS IS ONLY FOR LITTLE ENDIAN
